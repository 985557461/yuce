...
//        this.setBackgroundResource(R.drawable.wheel_bg);
		...
		paint.setColor(Color.parseColor("#f3f3f1"));
...
//        }
		canvas.drawLine(mSelectorBound.left,mSelectorBound.top,mSelectorBound.left+mSelectorBound.width(),mSelectorBound.top,paint);
		canvas.drawLine(mSelectorBound.left,mSelectorBound.bottom,mSelectorBound.left+mSelectorBound.width(),mSelectorBound.bottom,paint);
    }
