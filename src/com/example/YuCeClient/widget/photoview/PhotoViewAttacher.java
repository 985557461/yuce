 ...
 *******************************************************************************/
package com.example.YuCeClient.widget.photoview;
...
import com.example.YuCeClient.widget.photoview.gestures.OnGestureListener;
import com.example.YuCeClient.widget.photoview.gestures.VersionedGestureDetector;
import com.example.YuCeClient.widget.photoview.scrollerproxy.ScrollerProxy;
...
public class PhotoViewAttacher implements IPhotoView, View.OnTouchListener,
	...
	private com.example.YuCeClient.widget.photoview.gestures.GestureDetector mScaleDragDetector;
	...
	public void onDrag(float dx, float dy) {
		...
		if (DEBUG) {
			Debug.debug(LOG_TAG, String.format("onDrag: dx: %.2f. dy: %.2f", dx, dy));
		}
	...
	private class FlingRunnable implements Runnable {
		...
		public void cancelFling() {
			if (DEBUG) {
				Debug.debug(LOG_TAG, "Cancel Fling");
			}
