 ...
 */
public class TotalPaiHangBangView extends FrameLayout implements RefreshListView.OnRefreshListener, RefreshListView.OnLoadMoreListener {
	...
	public TotalPaiHangBangView(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		init(context);
	}

	public TotalPaiHangBangView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public TotalPaiHangBangView(Context context) {
		super(context);
		init(context);
	}
